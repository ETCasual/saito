...
const courses = new Array(5).fill({
              ...
              <div className="relative h-full w-full" key={i}>
                <div className="relative h-full w-full overflow-hidden rounded-tl-[3rem]">
                  <img
                    ...
                    src={c.image}
                  />
                  <div className="absolute left-0 top-0 flex h-full w-full cursor-pointer flex-col justify-end bg-gradient-to-b from-[#00000000] from-30% to-[#000] to-70% px-5 py-4 font-montserrat text-xl font-bold text-white transition duration-200 ease-in-out hover:to-primary">
                    {c.label}
                  </div>
                </div>
                {i === 1 ? (
